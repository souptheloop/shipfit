...
describe("Piano Component", () => {
    ...
    //         const [component, shadowRoot] = render(`<piano-keys key-count=3/>`) as [FittingElement, ShadowRoot];
    //
...
const byHorizontalPosition = (a, b) => {
    const aPos = parseInt(a.getAttribute("x"));
    const bPos = parseInt(b.getAttribute("x"));
    return aPos - bPos;
};
const displayName = (value) => value.getAttribute("data-note") + "-" + value.getAttribute("data-octave");
...
//# sourceMappingURL=piano.test.js.map